(function (mw, $, kWidget) {
    ...
    mw.PluginManager.add('sskShareButton', mw.KBaseScreen.extend({
        ...
        defaultConfig: {
            ...
            shareOffset: true,
            templatePath: '../SSK/resources/sskShareScreen.tmpl.html'
        },
        ...
        getComponent: function () {
            if (!this.$el) {
                var _this = this;
                this.$el = $('<a class="button">Teilen</a>')
                    .addClass('share')
                    .prepend('<i class="icon-share"></i>')
                    .click( function(){
                        _this.toggleScreen();
                    });
            }
